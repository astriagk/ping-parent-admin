...
export const routeRoles: Record<string, string[]> = {
  ...
  '/schools/school-drivers/list': ['superadmin', 'admin', 'school_admin'],
  '/schools/school-drivers/assign': ['superadmin', 'admin', 'school_admin'],
  '/assignments/driver-student/assign': ['school_admin'],
